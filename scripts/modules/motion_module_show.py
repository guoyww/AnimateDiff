...
class MotionModuleSafePatch:
    """
    Version patchée de MotionModuleSafe pour éviter les erreurs de dimension.
    - Convertit la concaténation de latents en addition pour compatibilité UNet.
    - Injecte un bruit minimal si frames trop faibles.
    - Affichage debug optionnel.
    """
    def __init__(self, verbose=False, min_threshold=1e-3, noise_scale=1e-2):
    ...
    def __call__(self, latents, init_image_scale_override=None):
